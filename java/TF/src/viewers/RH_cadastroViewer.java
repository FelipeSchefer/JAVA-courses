...
import models.CalculaSalarioRH;
import models.CargoRH;
import models.Endereco;
import models.Funcionario;

public class RH_cadastroViewer {
	public String cadastrarFuncionario(List<Funcionario> funcionarios) throws InputMismatchException {
		try {
			...
			CalculaSalario rh = new CalculaSalarioRH(nomeCargo ,valorHora , hora ); // 4 Liskov Substitution Principle 
			mostraSalario = rh.somar();
